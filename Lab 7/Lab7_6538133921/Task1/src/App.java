public class App {
    public static void main(String[] args) throws Exception {
        ...
        cart = new DiscountByAmountDecorator(cart, 5.0);
        cart = new DiscountByAmountDecorator(cart, 7.0);
        cart = new DiscountByAmountDecorator(cart, 20.0);
        cart = new DiscountByPercentDecorator(cart, 10.0);
        cart = new DiscountByPercentDecorator(cart, 50.0);
